...
# TODO do przetestowania zaokr¹glenia
...
#' 
#' Aby zapobiec skutkom b³edów numerycznych, domyœlnie wartoœci \code{x}, jak i \code{bucket$srodek},
#' \code{bucket$od}, \code{bucket$do} zaokr¹glone s¹ do 15-tej cyfry znacz¹cej.
#' 
...
#' @param round Czy zaokr¹glaæ. Domyœlnie tak.
#' @param digits Do której cyfry znacz¹cej zaokr¹glaæ. Domyœlnie do 15-tej.
#' 
...
#' 
#' #' Aby zapobiec skutkom b³edów numerycznych, domyœlnie wartoœci \code{x}, jak i \code{bucket$srodek},
#' \code{bucket$od}, \code{bucket$do} zaokr¹glone s¹ do 15-tej cyfry znacz¹cej. Podobnie przy zmiennych
#' dyskretnych numerycznych. Wiêcej szczegó³ów w \code{\link{przypisz}}.
#' 
#'
#' @param x Wektor zmiennych numerycznych. 
